...
const letterData = {
    ...
    sound: "audio/audio/bbb.mp3",
    syllables: [
        { text: "با", sound: "audio/audio/baa.mp3" },
        { text: "بو", sound: "audio/audio/boo.mp3" },
        { text: "بي", sound: "audio/audio/bee.mp3" }
    ],
    words: [
        { text: "باب", image: "images/bab.jpg", sound: "audio/audio/Bab.mp3" },
        { text: "بطة", image: "images/bata.jpg", sound: "audio/audio/Bataa.mp3" },
        { text: "بيت", image: "images/bayte.jpg", sound: "audio/audio/Bayt.mp3" }
    ]
};
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    syllableButtons.forEach(function (button) {
        button.onclick = function () {
            ...
            if (text === "با") {
                audioFile = "audio/audio/baa.mp3";
            } else if (text === "بو") {
                audioFile = "audio/audio/boo.mp3";
            } else if (text === "بي") {
                audioFile = "audio/audio/bee.mp3";
            }
    ...
    wordButtons.forEach(function (button) {
        button.onclick = function () {
            ...
            if (word === "باب") {
                audioFile = "audio/audio/Bab.mp3";
            } else if (word === "بطة") {
                audioFile = "audio/audio/Bataa.mp3";
            } else if (word === "بيت") {
                audioFile = "audio/audio/Bayt.mp3";
            }
...
if (playLetterBtn) {
    playLetterBtn.onclick = function () {
        let audio = new Audio("audio/audio/bbb.mp3");
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (playLetterBtn) {
        playLetterBtn.onclick = function () {
            let audio = new Audio("audio/bb.mp3"); 
            audio.play().catch(function(error) {
                console.log("خطأ في تشغيل الصوت: ", error);
            });
        };
