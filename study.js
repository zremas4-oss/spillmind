...
const sayButtons = document.querySelectorAll("#section1 .saySyllable");
sayButtons.forEach(function(button) {
    button.onclick = function() {
        let target = button.getAttribute("data-text");
...
const activities = [
    "🦘 اقفز 10 مرات",
    "🦋 حرّك يديك مثل الفراشة",
    "🙆 مدّ ذراعيك للأعلى",
    "🚶 امشِ في مكانك قليلاً"
];
...
setInterval(function () {
    ...
    if (appTime === 1200) {
        ...
        alert("🌙 أحسنت يا بطل! حان وقت الراحة، نكمل غداً بإذن الله 💙");

        // يمكن لاحقاً نستبدلها بصفحة نهاية أجمل
    }
...
function startBreak() {
    ...
    setTimeout(function(){
        ...
        alert("✨ انتهت الراحة! هيا نكمل رحلة التعلم 🚀");
